...
const REQUIRED_KEYS = [
  ...
  "voice.cameraFailed",
  "voice.serverNotConfigured",
  "voice.serverNotConfiguredHelp",
  "voice.settingsEnabled",
  "voice.settingsEnabledHelp",
  "voice.settingsAccessMode",
  "voice.accessMembers",
  "voice.accessMembersHelp",
  "voice.accessOpen",
  "voice.accessOpenHelp",
  "voice.settingsProximity",
  "voice.settingsProximityHelp",
  "voice.settingsProximityRadius",
  "voice.settingsProximityRadiusHelp",
  "settings.voice",
